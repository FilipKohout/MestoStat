...
URLS: Final[Dict[
    ...
    #     "https://data.csu.gov.cz/api/dotaz/v1/data/vybery/uzivatelske/25b5ffc4-405c-4a1b-9dca-0c605edcb645?format=CSV&rozsah=CELY_VYBER&poznamky=false&kodZvlast=true",
    #     "csv",
    ...
    #     "https://data.csu.gov.cz/api/dotaz/v1/data/vybery/uzivatelske/09116ec4-f108-47ea-9fee-a7002c3c67b8?format=CSV&rozsah=CELY_VYBER&poznamky=false&kodZvlast=true",
    #     "csv",
    ...
    "PopulationByAge1stJanYearly": (
        "https://data.csu.gov.cz/api/dotaz/v1/data/vybery/uzivatelske/e726720a-75b3-4f4a-a826-a831b74f0104?format=CSV&rozsah=CELY_VYBER&poznamky=false&kodZvlast=true",
        "csv",
        lambda data: read_by_age(data),
    ...
    #     "https://data.csu.gov.cz/api/dotaz/v1/data/vybery/uzivatelske/1d35f85c-df4d-4d04-843e-3b20e08273fc?format=CSV&rozsah=CELY_VYBER&poznamky=false&kodZvlast=true",
    #     "csv",
    #     read_unemployment,
    #     "unemployment_data",
    #     7 * 24 * 60 * 60,
