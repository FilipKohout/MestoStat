...
URLS: Final[Dict[
    ...
    "PopulationByAge1stJanYearly": (
        "https://data.csu.gov.cz/api/dotaz/v1/data/vybery/uzivatelske/fad46aa0-bcf8-448b-8493-efd348e80d2b?format=CSV&rozsah=CELY_VYBER&poznamky=false&kodZvlast=true",
        "csv",
