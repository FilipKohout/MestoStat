...
CREATE OR REPLACE VIEW budget_data_detailed AS
SELECT
    municipality_id,
    date_recorded,
...
INSERT INTO statistics (table_name, last_updated, periodicity_id, structure_level_id, source_domain)
VALUES ('budget_data_detailed', NOW(), (SELECT periodicity_id FROM periodicities WHERE periodicity_name = 'Měsíčně'), (SELECT structure_level_id FROM structure_levels WHERE structure_level_name = 'Obec'), 'https://monitor.statnipokladna.gov.cz')
ON CONFLICT (table_name) DO NOTHING;

INSERT INTO statistic_columns (table_id, column_name, alias, aggregation_method)
VALUES
    ((SELECT table_id FROM statistics WHERE table_name = 'budget_data_detailed'), 'agriculture', 'zemědělství', 'SUM'),
    ((SELECT table_id FROM statistics WHERE table_name = 'budget_data_detailed'), 'forestry', 'lesnictví', 'SUM'),

    ((SELECT table_id FROM statistics WHERE table_name = 'budget_data_detailed'), 'roads', 'silnice', 'SUM'),
    ((SELECT table_id FROM statistics WHERE table_name = 'budget_data_detailed'), 'sidewalks', 'chodníky a cyklostezky', 'SUM'),
    ((SELECT table_id FROM statistics WHERE table_name = 'budget_data_detailed'), 'public_transport', 'veřejná doprava', 'SUM'),
    ((SELECT table_id FROM statistics WHERE table_name = 'budget_data_detailed'), 'transport_other', 'ostatní doprava', 'SUM'),

    ((SELECT table_id FROM statistics WHERE table_name = 'budget_data_detailed'), 'water_supply', 'pitná voda', 'SUM'),
    ((SELECT table_id FROM statistics WHERE table_name = 'budget_data_detailed'), 'sewage', 'kanalizace a ČOV', 'SUM'),
    ((SELECT table_id FROM statistics WHERE table_name = 'budget_data_detailed'), 'watercourses', 'vodní toky', 'SUM'),

    ((SELECT table_id FROM statistics WHERE table_name = 'budget_data_detailed'), 'kindergarten', 'mateřské školy', 'SUM'),
    ((SELECT table_id FROM statistics WHERE table_name = 'budget_data_detailed'), 'primary_school', 'základní školy', 'SUM'),
    ((SELECT table_id FROM statistics WHERE table_name = 'budget_data_detailed'), 'school_meals', 'školní stravování', 'SUM'),
    ((SELECT table_id FROM statistics WHERE table_name = 'budget_data_detailed'), 'art_school', 'ZUŠ a umělecké školy', 'SUM'),
    ((SELECT table_id FROM statistics WHERE table_name = 'budget_data_detailed'), 'education_other', 'ostatní vzdělávání', 'SUM'),

    ((SELECT table_id FROM statistics WHERE table_name = 'budget_data_detailed'), 'libraries', 'knihovny', 'SUM'),
    ((SELECT table_id FROM statistics WHERE table_name = 'budget_data_detailed'), 'culture_houses', 'kulturní domy', 'SUM'),
    ((SELECT table_id FROM statistics WHERE table_name = 'budget_data_detailed'), 'monuments', 'památky', 'SUM'),
    ((SELECT table_id FROM statistics WHERE table_name = 'budget_data_detailed'), 'media', 'rozhlas a zpravodaj', 'SUM'),
    ((SELECT table_id FROM statistics WHERE table_name = 'budget_data_detailed'), 'culture_other', 'ostatní kultura', 'SUM'),

    ((SELECT table_id FROM statistics WHERE table_name = 'budget_data_detailed'), 'sport_facilities', 'sportoviště', 'SUM'),
    ((SELECT table_id FROM statistics WHERE table_name = 'budget_data_detailed'), 'playgrounds', 'dětská hřiště', 'SUM'),
    ((SELECT table_id FROM statistics WHERE table_name = 'budget_data_detailed'), 'leisure_centers', 'střediska volného času', 'SUM'),

    ((SELECT table_id FROM statistics WHERE table_name = 'budget_data_detailed'), 'public_lighting', 'veřejné osvětlení', 'SUM'),
    ((SELECT table_id FROM statistics WHERE table_name = 'budget_data_detailed'), 'waste', 'svoz odpadu', 'SUM'),
    ((SELECT table_id FROM statistics WHERE table_name = 'budget_data_detailed'), 'greenery', 'veřejná zeleň', 'SUM'),
    ((SELECT table_id FROM statistics WHERE table_name = 'budget_data_detailed'), 'municipal_housing', 'obecní byty', 'SUM'),
    ((SELECT table_id FROM statistics WHERE table_name = 'budget_data_detailed'), 'communal_services', 'komunální služby', 'SUM'),
    ((SELECT table_id FROM statistics WHERE table_name = 'budget_data_detailed'), 'funerals', 'pohřebnictví', 'SUM'),

    ((SELECT table_id FROM statistics WHERE table_name = 'budget_data_detailed'), 'senior_homes', 'domovy pro seniory', 'SUM'),
    ((SELECT table_id FROM statistics WHERE table_name = 'budget_data_detailed'), 'care_service', 'pečovatelská služba', 'SUM'),
    ((SELECT table_id FROM statistics WHERE table_name = 'budget_data_detailed'), 'social_family', 'rodina a děti', 'SUM'),
    ((SELECT table_id FROM statistics WHERE table_name = 'budget_data_detailed'), 'social_other', 'ostatní sociální služby', 'SUM'),

    ((SELECT table_id FROM statistics WHERE table_name = 'budget_data_detailed'), 'firefighters', 'hasiči', 'SUM'),
    ((SELECT table_id FROM statistics WHERE table_name = 'budget_data_detailed'), 'police', 'městská policie', 'SUM'),
    ((SELECT table_id FROM statistics WHERE table_name = 'budget_data_detailed'), 'security_other', 'krizové řízení', 'SUM'),

    ((SELECT table_id FROM statistics WHERE table_name = 'budget_data_detailed'), 'council_salaries', 'platy zastupitelů', 'SUM'),
    ((SELECT table_id FROM statistics WHERE table_name = 'budget_data_detailed'), 'administration_office', 'provoz úřadu', 'SUM'),
    ((SELECT table_id FROM statistics WHERE table_name = 'budget_data_detailed'), 'elections', 'volby', 'SUM'),
    ((SELECT table_id FROM statistics WHERE table_name = 'budget_data_detailed'), 'financial_costs', 'bankovní a finanční poplatky', 'SUM'),

    ((SELECT table_id FROM statistics WHERE table_name = 'budget_data_detailed'), 'other_aggregated', 'nespecifikované výdaje', 'SUM'),
    ((SELECT table_id FROM statistics WHERE table_name = 'budget_data_detailed'), 'total_spending', 'total', 'SUM')
ON CONFLICT (table_id, column_name) DO NOTHING;




CREATE OR REPLACE VIEW budget_data_summary AS
SELECT
    municipality_id,
    date_recorded,
...
INSERT INTO statistics (table_name, last_updated, periodicity_id, structure_level_id, source_domain)
VALUES ('budget_data_summary', NOW(), (SELECT periodicity_id FROM periodicities WHERE periodicity_name = 'Měsíčně'), (SELECT structure_level_id FROM structure_levels WHERE structure_level_name = 'Obec'), 'https://monitor.statnipokladna.gov.cz')
ON CONFLICT (table_name) DO NOTHING;

INSERT INTO statistic_columns (table_id, column_name, alias, aggregation_method)
VALUES
    ((SELECT table_id FROM statistics WHERE table_name = 'budget_data_summary'), 'transport', 'doprava', 'SUM'),
    ((SELECT table_id FROM statistics WHERE table_name = 'budget_data_summary'), 'education', 'školství', 'SUM'),
    ((SELECT table_id FROM statistics WHERE table_name = 'budget_data_summary'), 'infrastructure_housing', 'bydlení a infrastruktura', 'SUM'),
    ((SELECT table_id FROM statistics WHERE table_name = 'budget_data_summary'), 'environment', 'životní prostředí', 'SUM'),
    ((SELECT table_id FROM statistics WHERE table_name = 'budget_data_summary'), 'culture_sport', 'kultura a sport', 'SUM'),
    ((SELECT table_id FROM statistics WHERE table_name = 'budget_data_summary'), 'social_health', 'sociální věci a zdraví', 'SUM'),
    ((SELECT table_id FROM statistics WHERE table_name = 'budget_data_summary'), 'admin_safety', 'správa a bezpečnost', 'SUM'),
    ((SELECT table_id FROM statistics WHERE table_name = 'budget_data_summary'), 'other_economy', 'ostatní hospodářství', 'SUM'),
    ((SELECT table_id FROM statistics WHERE table_name = 'budget_data_summary'), 'total_spending', 'total', 'SUM')
ON CONFLICT (table_id, column_name) DO NOTHING;